# Skin.Estuary.PVR.plus.matrix

EstuaryPVR+ (Matrix) is a modification of the default Estuary skin, originally written by Phil65 and now maintained by Team Kodi.
